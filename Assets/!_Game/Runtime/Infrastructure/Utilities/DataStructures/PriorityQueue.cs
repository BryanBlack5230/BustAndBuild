...
//
// Port of System.Collections.Generic.PriorityQueue (quaternary min-heap), which is
// absent from Unity's .NET Standard 2.1 profile. Ported from:
...
// Brought in via UGFW (MIT). Local changes: namespace, BCL throw-helper polyfills
// merged into ThrowHelper (to avoid shadowing System exception types namespace-wide).
namespace BarkingBird.Runtime.Infrastructure.Utilities
{
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        {
            ThrowHelper.ThrowIfNegative(initialCapacity);
