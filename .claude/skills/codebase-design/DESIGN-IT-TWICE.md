...
- Agent 4 (if applicable): "Design around ports & adapters for cross-seam dependencies." *(In this
  project that's usually a Reflex-injected service seam, not a network port.)*
...
---
*Fork of mattpocock `codebase-design` (DESIGN-IT-TWICE) — see ADR-0001.*
