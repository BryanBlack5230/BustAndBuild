Let's convert EventManager to a full EventBus, I want to be able to set priorities to subscribes with default being 0. You've already looked at the code of GenericEventBus before and found some problems with it. Fix the problems, before adding this code to the project.

Here is a EventBus implementation that i've found and thinking about using:
